...
SECRET_KEY = 'django-insecure-5d#=9o%ql2ass3c66n-kka@b_ve&ev4(n%m)5q69n_%0t9)7(3'
...
INSTALLED_APPS = [
    ...
    'catalog.apps.CatalogConfig', #LOL created in /catalog/apps.py
    'widget_tweaks',
    'django_bootstrap5',
...
MEDIA_URL = '/catalog/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'catalog/static/fotos') 
#LOL - here
